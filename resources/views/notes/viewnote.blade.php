            ...
            <tr>                                                
              ...
              <td>
                ...
                @if(Auth::user()->can('delete-note', App\Models\Note::class))                           
                  <a href= "/DeleteNote/{{$note['NoteID']}}" style="margin:10px" class="text-my-own-color"  onclick="return confirm('Are you sure you want to delete this item?');"><span data-feather ="trash-2"></span></a> 
                @endif
              </td>
            </tr>
            @endforeach
