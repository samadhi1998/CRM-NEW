...
<div class="container mb-5">
    <div class="d-flex align-items-end pt-4">
        ...
        <a href="/backup/create" style="color: white"> Create Backup</a>
        </button>
                    ...
                    @foreach($files as $file)
                        <tr>
                            ...
                            <td class="text-right pr-3">
                                <a class="action-button mr-2" href="{{ url('backup/download/'.$file['date']) }}" target="_blank" wire:click.prevent="downloadFile('{{ $file['path'] }}')">
